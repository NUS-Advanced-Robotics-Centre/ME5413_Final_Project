...
namespace rviz_panel
{
    ...
    // void ME5413ControlPanel::on_button_1_1_clicked()
    // {
    ...
    // }
    // void ME5413ControlPanel::on_button_1_2_clicked()
    // {
    ...
    // // Box buttons
    // void ME5413ControlPanel::on_button_2_1_clicked()
    // {
    ...
    //     this->pub_goal_.publish(this->goal_name_msg_);
    // }
    // void ME5413ControlPanel::on_button_2_2_clicked()
    // {
    ...
    //     this->pub_goal_.publish(this->goal_name_msg_);
    // }
    // void ME5413ControlPanel::on_button_2_3_clicked()
    // {
    ...
    //     this->pub_goal_.publish(this->goal_name_msg_);
    // }
    // void ME5413ControlPanel::on_button_2_4_clicked()
    // {
    ...
    // void ME5413ControlPanel::on_button_3_1_clicked()
    // {
    ...
    //     this->pub_goal_.publish(this->goal_name_msg_);
    // }
    // void ME5413ControlPanel::on_button_3_2_clicked()
    // {
    ...
    //     this->pub_goal_.publish(this->goal_name_msg_);
    // }
    // void ME5413ControlPanel::on_button_3_3_clicked()
    // {
